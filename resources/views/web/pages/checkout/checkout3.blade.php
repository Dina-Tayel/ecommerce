                                        ...
                                        <div class="panel-heading" role="tab" id="one">
                                            <h6 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse_one"><i class="icofont-mastercard-alt"></i> Pay with
                                                    Credit Card</a>
                                            </h6>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                     ...
                                     <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="five">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" required name="payment_method" value="cod" class="custom-control-input" id="customCheck1">
