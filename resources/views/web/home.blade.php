        ...
        <div class="welcome_slides owl-carousel">
            ...
            @if ($banners->count() > 0)
                @foreach ($banners as $banner)
                    <!-- Single Slide -->
                    <div class="single_slide bg-img" style="background-image: url({{ $banner->image_path }});">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    <div class="quickview_pro_img">
                                        <img class="first_img" src="{{ asset('web/img/product-img/new-1-back.png') }}"
                                            alt="">
                                        <img class="hover_img" src="{{ asset('web/img/product-img/new-1.png') }}"
                                            alt="">
                                        <!-- Product Badge -->
                            ...
                            @foreach ($new_products as $new_product)
                                ...
                                <div class="single-product-area">
                                    <div class="product_image">
                                        <!-- Product Image -->
                                        <img class="normal_img" src="{{ $new_product->image_path }}" alt="">
                                        ...
                                        <div class="product_wishlist">
                                            <a href="javascript:void(0)" class="add-to-wishlist"
                                                id="add-to-wishlist-{{ $new_product->id }}"
                                                data-id="{{ $new_product->id }}" data-qty="1"><i
                                    ...
                                    <div class="product_description">
                                        ...
                                        <p class="brand_name">{{ $new_product->brand->title }}</p>
                                        <a
                                            href="{{ route('product.details', $new_product->slug) }}">{{ $new_product->title }}</a>
                                        <h6 class="product-price">{{ number_format($new_product->offer_price, 2) }}
                                            @if ($new_product->discount > 0)
                                                <span>{{ number_format($new_product->price, 2) }} </span>
                                            @endif
                                        </h6>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured_offer_area d-flex align-items-center"
                        style="background-image: url(web/img/bg-img/fea_offer.jpg);">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="featured_product_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('web/img/product-img/new-2.png') }}"
                                    alt="">
                                <img class="hover_img" src="{{ asset('web/img/product-img/new-2-back.png') }}"
                                    alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('web/img/product-img/new-4.png') }}"
                                    alt="">
                                <img class="hover_img" src="{{ asset('web/img/product-img/new-4-back.png') }}"
                                    alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{ asset('web/img/product-img/new-7.png') }}"
                                    alt="">
                                <img class="hover_img" src="{{ asset('web/img/product-img/new-7-back.png') }}"
                                    alt="">
                                ...
                                <div class="top_sellers_area">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{ asset('web/img/product-img/top-2.png') }}"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Beach Cap</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{ asset('web/img/product-img/top-3.png') }}"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Gold Neckless</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{ asset('web/img/product-img/top-4.png') }}"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{ asset('web/img/product-img/top-5.png') }}"
                                                        alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sport Shoes</h5>
